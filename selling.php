...
<head>
    ...
    <title>Sooper Vegan | Selling History</title>
</head>
    ...
    <div class="container-fluid">
        <div class="col-12">
            <div class="row">
                ...
                <div class="col-12 fs-1 text-dark text-center"><i class="bi bi-bag-fill"></i>&nbsp;Selling History</div>
                <div class="col-12 p-3">
                    <div class="row">
                        <div class="col-6 offset-0 col-lg-3 offset-lg-2">
                            <span class="form-label">Sellings From</span></br>
                            <input type="date" id="from" class="form-control" />
                        </div>
                        <div class="col-6 offset-0 col-lg-3">
                            <span class="form-label">Sellings To</span></br>
                            <input type="date" id="to" class="form-control" />
                        </div>
                        <div class="col-12 col-lg-2">
                            <button class="btn btn-success col-12 mt-4" onclick="findSellings();">Show Sellings</button>
                        </div>
                    </div>
                </div>
                <div class="col-12 p-3">
                    <table class="table">
                        <thead class="bg-success text-center">
                            <tr>
                                <th scope="col">#</th>
                                <th scope="col" class="d-none d-lg-block">Product</th>
                                <th scope="col">Qty</th>
                        ...
                        <tbody class="text-center" id="bod">
                            <?php
                            $invoice_rs = Database::search("SELECT * FROM `invoice` UNION SELECT * FROM `deleted_purchases`  ORDER BY `date` DESC");
                            $invoice_rs1 = Database::search("SELECT * FROM `deleted_purchases`  ORDER BY `date` DESC");
                            ...
                            ?>
                                    ...
                                    <tr>
                                            ...
                                            <div class="card mb-3" style="max-width: 400px;">
                                                <div class="row g-0">
                                                    <div class="col-md-4">
                                                        ...
                                                        $product_rs1 = Database::search("SELECT * FROM `customer` WHERE `mobile` = '" . $invoice_data1["customer_mobile"] . "'");
                                        ...
                                        <td class="text-center">
                                            <div class="row">
                                                ...
                                                ?>
                                                    <button class="col-12 offset-1 col-lg-6 btn btn-warning m-1 d-block" id="con<?php echo ($invoice_data["id"]);  ?>" onclick="confirm('<?php echo ($invoice_data['id']);  ?>');">Confirm</button>
                                            </div>
                                    ...
                                    ?>
                                        <button class="col-12 col-lg-6 btn btn-warning m-1 d-none" id="con<?php echo ($invoice_data["id"]);  ?>" onclick="confirm('<?php echo ($invoice_data['id']);  ?>');">Confirm</button>
